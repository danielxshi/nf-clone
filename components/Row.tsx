...
const handeleClick = (direction: string) => {
    setIsMoved
}
    ...
    return (
        <div className='h-40 space-y-0.5 md:space-y-2'>
            ...
            <div className='group relative md:-ml-2'>
                ...
                <ChevronRightIcon className="absolute top-0 bottom-0 left-2 z-40 m-auto h-9 w-9 cursor-pointer opacity-0 transition hover:scale-125 group-hover:opacity-100" onClick={() => handleClick('right')}/>
            </div>
        </div>
    )
}
